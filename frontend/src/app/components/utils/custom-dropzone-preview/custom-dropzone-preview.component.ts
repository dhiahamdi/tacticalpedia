...
@Component({
  selector: 'ngx-dropzone-custom-preview',
  template: `
    <img *ngIf="type!=='video'" [src]="imageSrc" />
    <video *ngIf="sanitizedVideoSrc && type=='video'" (click)="$event.stopPropagation()">
...
export class CustomDropzonePreviewComponent extends NgxDropzonePreviewComponent implements OnInit, OnDestroy {
